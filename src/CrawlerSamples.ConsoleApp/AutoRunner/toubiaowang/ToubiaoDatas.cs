...
namespace CrawlerSamples.AutoRunner.carFamily
{
    ...
    public class ToubiaoDatas : ExcelBase
    {
        ...
        public static void IntrusiveExport(List<ToubiaoDatas> list)
        { 
            string[] sex = new string[] { "男", "女" };
            Random random = new Random();
            //for (var i = 0; i < 100; i++)
            //{
            //    list.Add(new ToubiaoDatas()
            //    { 
            //    });
            //}
